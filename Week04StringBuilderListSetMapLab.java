...
public class Week04StringBuilderListSetMapLab {
	...
	public static void main(String[] args) {
		...
		// A String builder can be manipulated and changed where as a string is just chars saved in memory
	   ...
	   System.out.println(combineStrings(swapped));
		...
		List<List<Integer>> sortedNumbers = sortDivisibileNumbers(numbers);
	...
	for (String listString : resultList) {
		...
		dictionary.put("Java", "A programing launguage createed in 1995 and still heavily used today");
	...
	// Method 7:
	public static List<List<Integer>> sortDivisibileNumbers(List<Integer> list){
